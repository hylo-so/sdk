...
impl<L: LST + Local> SimulatedOperation<L, HYUSD> for ExchangeClient {
  ...
  fn from_event(event: &Self::Event) -> Result<OperationOutput<N9, N6, N9>> {
...
impl<L: LST + Local> SimulatedOperation<HYUSD, L> for ExchangeClient {
  ...
  fn from_event(event: &Self::Event) -> Result<OperationOutput<N6, N9, N9>> {
  ...
  for ExchangeClient
{
  ...
  fn from_event(event: &Self::Event) -> Result<OperationOutput<N9, N9, N9>> {
