...
const LUT_ACCOUNTS: &[Pubkey] = &[
  ...
  pda::fee_vault(JITOSOL::MINT, token::ID),
  ...
  pda::fee_vault(HYLOSOL::MINT, token::ID),
  pda::lst_vault(HYLOSOL::MINT),
  pda::lst_header(HYLOSOL::MINT),
  HYLOSOL::POOL_STATE,
  // hyUSD fee accounts
  pda::fee_auth(HYUSD::MINT),
  pda::fee_vault(HYUSD::MINT, token::ID),
  // USDC accounts
  pda::usdc_vault_auth(USDC::MINT),
  pda::fee_auth(USDC::MINT),
  pda::ata(pda::usdc_vault_auth(USDC::MINT), USDC::MINT, token::ID),
  pda::ata(pda::fee_auth(USDC::MINT), USDC::MINT, token::ID),
  // CBBTC accounts
  ...
  pda::ata(pda::fee_auth(HYPE::MINT), HYPE::MINT, HYPE::TOKEN_PROGRAM),
  // Standard programs
  token::ID,
