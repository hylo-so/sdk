...
pub fn mint_stablecoin_lst(
  ...
  MintStablecoinLst {
    ...
    user_lst_ta: pda::ata(user, lst_mint, token::ID),
...
pub fn register_exo(
  ...
  RegisterExo {
    ...
    levercoin_mint,
    vault_auth,
    collateral_vault: pda::ata(
      vault_auth,
      collateral_mint,
      collateral_token_program,
    ),
    fee_auth,
    fee_vault: pda::ata(fee_auth, collateral_mint, collateral_token_program),
...
pub fn mint_levercoin_exo(
  ...
  MintLevercoinExo {
    ...
    fee_vault: pda::ata(fee_auth, collateral_mint, collateral_token_program),
    user_collateral_ta: pda::ata(
      user,
      collateral_mint,
      collateral_token_program,
    ),
    user_levercoin_ta: pda::ata(user, levercoin_mint, token::ID),
    collateral_mint,
    levercoin_mint,
...
pub fn genesis_mint_exo(
  ...
  GenesisMintExo {
    ...
    admin_collateral_ta: pda::ata(
      admin,
      collateral_mint,
      collateral_token_program,
    ),
    dead_levercoin_ta: pda::ata(pda::DEAD, levercoin_mint, token::ID),
...
pub fn withdraw_fees(
  ...
  WithdrawFees {
    ...
    hylo: pda::HYLO,
    fee_auth,
    fee_vault: pda::ata(fee_auth, fee_token_mint, token_program),
    treasury_ata: pda::ata(treasury, fee_token_mint, token_program),
    fee_token_mint,
    associated_token_program: associated_token::ID,
    token_program,
    system_program: system_program::ID,
...
pub fn swap_lst_to_lst(
  ...
  SwapLstToLst {
    ...
    fee_vault: pda::fee_vault(lst_a, token::ID),
    token_program: token::ID,
    event_authority: pda::EXCHANGE_EVENT_AUTHORITY,
    program: exchange::ID,
  }
...
pub fn settle_virtual_stablecoin_exo(
  ...
  SettleVirtualStablecoinExo {
    ...
    stablecoin_pool: pda::HYUSD_POOL,
    collateral_vault: pda::exo_vault(collateral_mint, collateral_token_program),
    collateral_mint,
    stablecoin_mint: HYUSD::MINT,
    collateral_usd_pyth_feed,
    token_program: token::ID,
...
pub fn settle_virtual_stablecoin_usdc() -> SettleVirtualStablecoinUsdc {
  ...
  SettleVirtualStablecoinUsdc {
    ...
    pool_auth: pda::POOL_AUTH,
    usdc_vault_auth,
    usdc_collateral_vault: pda::ata(usdc_vault_auth, USDC::MINT, token::ID),
    stablecoin_pool: pda::HYUSD_POOL,
    usdc_mint: USDC::MINT,
    stablecoin_mint: HYUSD::MINT,
...
pub fn swap_lst_to_usdc(
  ...
  SwapLstToUsdc {
    ...
    settlement_auth: pda::SETTLEMENT_AUTH,
    lst_vault: pda::lst_vault(lst_mint),
    usdc_vault: pda::ata(usdc_vault_auth, USDC::MINT, token::ID),
    stablecoin_pool: pda::HYUSD_POOL,
    user_lst_ta: pda::ata(user, lst_mint, token::ID),
    user_usdc_ta: pda::usdc_ata(user),
    lst_mint,
...
pub fn initialize_usdc(
  ...
  InitializeUsdc {
    ...
    usdc_fee_auth,
    usdc_collateral_vault: pda::ata(usdc_vault_auth, USDC::MINT, token::ID),
    usdc_fee_vault: pda::ata(usdc_fee_auth, USDC::MINT, token::ID),
    usdc_mint: USDC::MINT,
    usdc_usd_pyth_feed,
    token_program: token::ID,
    associated_token_program: associated_token::ID,
