...
- `ProtocolState::redemption_rate` is not a quote strategy: it is a state-derived
  fair-value rate for oracle feeds. It survives route gates and a CR above the redeem
  fee-curve domain
